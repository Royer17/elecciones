...
document.querySelector(`#send-document`)
    .addEventListener('click', () => {
        ...
        //_formData.append('multiple_offices_id', $(`select[name="offices_id"]`).val());
            ...
            $.ajax({
                url : `/logged-solicitude/${document.querySelector('#internal-solicitude_form input[name="order_id"]').value}`,
                type: 'POST',
                data: _formData,
                contentType: false,
                processData: false,
...
document.querySelector('#internal-solicitude_form select[name="tupa_id"]').value = document.querySelector('#tupa_id_value').value
document.querySelector('#internal-solicitude_form select[name="subject"]').value = document.querySelector('#subject_value').value
