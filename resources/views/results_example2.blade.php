...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="page-header">
            <h1>
                <i class="fa fa-trophy"></i> Panel de Resultados Electorales
            </h1>
            <ol class="breadcrumb">
                <li><a href=""><i class="fa fa-home"></i> Inicio</a></li>
                <li>&nbsp;>&nbsp;</li>
                <li class="active">Resultados de los Comicios Estudiantiles
                    </h1>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                <div class="box box-solid box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i class="fa fa-chart-line"></i> Análisis de Resultados
                        </h3>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="panel panel-info mb-4">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <i class="fa fa-percentage"></i> Estadísticas de Participación
                                    </h4>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="info-box bg-warning">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text">Participación:</span>
                                        ...
                                        <div class="chart-section col-md-12">
                                            <input type="hidden" name="values"
                                                value="{{ json_encode($result['values']) }}">
                                            <input type="hidden" name="labels"
                                                value="{{ json_encode($result['labels']) }}">
                                            <canvas id="electionChart{{ $result['nivel'] }}"
                                                style="height:230px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
