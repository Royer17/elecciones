...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="page-header">
            <h1>
                <i class="fa fa-chart-bar"></i> Resultados de las Elecciones Estudiantiles
            </h1>
            <ol class="breadcrumb">
                <li><a href=""><i class="fa fa-home"></i> Inicio</a></li>
                <li class="active">Reporte de Resultados</li>
            </ol>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i class="fa fa-poll"></i> Estadísticas de Votación
                        </h3>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="panel panel-default mb-4">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <i class="fa fa-user-graduate"></i> Nivel:
                                        {{ $result['nivel_text'] }}
                                    </h4>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-box bg-blue">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text">Estudiantes que votaron:</span>
                                                    <span
