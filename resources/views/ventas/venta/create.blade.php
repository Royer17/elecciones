            ...
            <div class="panel-body">
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="pidarticulo" class="form-control selectpicker" id="pidarticulo" data-live-search="true">
                            ...
                            <option value="{{$articulo->idarticulo}}_{{$articulo->stock}}_{{$articulo->precio_promedio}}_{{$articulo->precio_promedio2}}_{{$articulo->precio_promedio3}}_{{$articulo->precio_promedio4}}">{{$articulo->articulo}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        ...
                        placeholder="P. venta"> --}}
                        <select id="pprecio_venta" class="form-control" name="pprecio_venta">
                            <option selected disabled>P. venta</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
...
<script>
  ...
  function mostrarValores()
  {
    ...
    for (var i = 2; i < 6; i++) {
        var option = '<option value="'+datosArticulo[i]+'">'+datosArticulo[i]+'</option>'
        $("#pprecio_venta").append(option);
    }
  }
