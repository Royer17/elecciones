...
<div class="row">
	...
	<div class="col-md-12">
		<h3 class="font-bold">Estudiantes registrados <a href="/admin/registrar-estudiante"
				class="btn btn-primary btn-sm">Nuevo</a></h3>
		<div id="filters_accordion">
			<div class="card">
				<div class="card-header py-1">
					<a class="collapsed card-link" data-toggle="collapse" href="#filter_1">
						<div class="title_filters"><label>Filtros</label><i class="fa fa-filter"></i></div>
					</a>
				</div>
						...
						<div class="row align-items-end">
								...
								<div class="form-group mb-0">
									...
									<div class="input-group">
										<input type="text" class="form-control" name="searchText"
											placeholder="Buscar por DNI, Nombres..." value="{{ $searchText }}">
							...
							<div class="col-sm-auto mb-3">
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button type="button" id="student__import" class="btn btn-primary"><i
	...
	<script>
		...
		$(document).on('click', '.action', function (e) {
			...
			let _that = $(this).parent(),
				_order_id = _that[0].dataset.index,
				_new_status = _that[0].dataset.new_status;
					...
					if (result.value) {
						...
						$.ajax({
							...
							error: function (jqXHR, textStatus, errorThrown) {
								notice(jqXHR.responseJSON.title, jqXHR.responseJSON.message,
									`warning`);
								unlockWindow();
							}
						});
