               ...
               @foreach ($orders as $key => $cat)
				<tr>
					...
					<td>
						...
						--}}
						@if($cat->status == 5)
						<a href="" data-index="{{ $cat->id }}" data-new_status="6" data-target="#modal-delete-" data-toggle="modal"><button class="btn btn-info action" style="margin: 2px;padding: 4px;">RECIBIR</button></a>
						@endif
