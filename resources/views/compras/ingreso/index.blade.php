...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Ingresos
			...
			<a href="{{url('reporteingresos')}}" target="_blank"><button class="btn btn-info">Reporte</button></a>
			<a href="{{url('excelingresos')}}"><button class="btn btn-primary">Excel General</button></a>
			<a href="{{url('excelingresos'.'?q=mes')}}"><button class="btn btn-primary">Excel del Mes</button></a>
		</h3>
